...
import styles from '../styles/ElmoreDrop/StartCollection.module.scss';
import {
  mobilePropertiesPlusSign,
  oneyellow,
  twoyellow,
  threeyellow,
} from '../../../assets/index';
        ...
        <div className={styles.mobilePropertiesSection}>
          <div className={styles.section}>
            <div className={styles.data}>
              <MobileCollData
                numberMobile={oneyellow}
                name="COLLECT"
                description="Start your digital art collection from the world’s greatest artists"
              />
              <MobileCollData
                numberMobile={twoyellow}
                name="CURATE"
                description="Curate your very own virtual gallery and share it with the world."
              />
            </div>
