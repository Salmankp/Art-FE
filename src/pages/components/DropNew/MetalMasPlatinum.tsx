...
import { Platinumtextimg, metalplatinum } from '../../../assets';

const MetalMasPlatinum: React.FC<{ drop3DEditionImageUrl: string }> = ({
  drop3DEditionImageUrl,
}) => {
...
export default MetalMasPlatinum;
