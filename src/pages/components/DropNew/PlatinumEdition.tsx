...
const PlatinumEdition: React.FC = () => {
      ...
      <Container className={styles.platinumContainer}>
        <Box className={styles.platinumWrapper}>
          ...
          <div className={styles.platinumRightImg}>
            <img src={badge68} className={styles.leftBadge} />
            <img src={fantasytwoimg} className={styles.oneOfOne} />
            <img src={badge66} className={styles.rightBadge} />
          </div>
        </Box>
      </Container>
    </div>
...
export default PlatinumEdition;
