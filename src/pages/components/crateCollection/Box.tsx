  ...
  return (
    <>
      <div className={owned?.ownedMints ? styles.greenOverlay : styles.overlay}>
        ...
        <MBox className={styles.videoIcons}>
          {mediaType === 'MP4' && (
            <>
              {!isPlay && (
                <MBox
...
function Box(props: BoxProps) {
  ...
  const paintingName = item?.paintingID?.name || '';
  const artistName = getArtistNames(item?.paintingID?.artists) || '';
  const unlist = () => {
    setLoading(true);
    try {
  ...
  return (
    <>
      {/* Apply this class if card is active ${styles.activeGreen} ${styles.activeOrange} */}
      <div
      ...
      >
        <div className={styles.row}>
          <div className={styles.item}>
            <div className={styles.paper}>
              <div className={owned?.ownedMints ? styles.image2 : styles.image}>
                ...
                >
                  ...
                  {item?.paintingID?.filetype !== 'MP4' ? (
                    <img
                      ...
                      className={`${styles.main_image} ${
                        owned?.ownedMints && styles.rmvBordr
                      }`}
                    />
                  ) : (
                    <div
                      className={`${styles.player} ${styles.hidePlayer}`}
                      style={{ borderWidth: 0 }}
                    >
                  ...
                  {(owned?.ownedMints || item?.totalOwnedMints?.length) && (
              ...
              {showMinimalInfo ? (
                ...
                <div className={styles.details}>
                  ...
                  {/* <span className={styles.listedSpan}>Listed</span> */}
                  <br />
            ...
            {!isUnList && showQuickListButton && isMyAsset && (
              <>
                <div>
            ...
            {!isUnList && showQuickListButton && isMarketplaceListings && (
              <>
                <div>
                  <button
